...
static float32_t circle_shadow300(float32_2_t coord, float32_2_t *shadow) {
...
static bool ds2022_map_nearest(const near_map_t *self, float32_2_t coord, float32_2_t *near) {
    float32_t x = coord.x;
    float32_t y = coord.y;
    float32_2_t shadow;
    if (x < 300) {
        if (y < 300) {
            circle_shadow300((float32_2_t) {x - 300, y - 300}, &shadow);
            *near = (float32_2_t) {shadow.x + 300, shadow.y + 300};
        } else if (y < 900) {
            *near = (float32_2_t) {0, y};
        } else {
            circle_shadow300((float32_2_t) {x - 300, y - 900}, &shadow);
        ...
        if (y < 300) {
            float32_t len = circle_shadow300((float32_2_t) {x - 1200, y - 300}, &shadow);
            if (len - 300 > y) {
                *near = (float32_2_t) {x, 0};
            }
        ...
        if (y < 300) {
            circle_shadow300((float32_2_t) {x - 1500, y - 300}, &shadow);
            *near = (float32_2_t) {shadow.x + 1500, shadow.y + 300};
        } else if (y < 900) {
            *near = (float32_2_t) {1800, y};
        } else {
            circle_shadow300((float32_2_t) {x - 1500, y - 900}, &shadow);
